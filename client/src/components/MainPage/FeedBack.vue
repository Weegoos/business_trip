<template>
  <div class="text-white q-pa-xl">
    <img
      ...
      alt=""
    />
    <p class="textHeadline">What Our Clients Say</p>
      ...
      >
        ...
        >
          ...
          <div class="row q-mt-lg">
            ...
            <section class="col">
              <span class="feedbackAuthorInfo">{{ items.author }}</span>
              <span class="feedbackAuthorInfo">{{ items.location }}</span>
            </section>
          </div>
        </q-card>
      </div>
